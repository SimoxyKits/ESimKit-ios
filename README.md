...
4) Configure your application to use the App Store Server Notifications Production URL provided by the Simoxy Team. If you already have an existing URL, please use this PHP repository to forward notifications to our servers.
...
2) Drag and drop the framework into your Application's Frameworks folder.
	...
	Don't forget to check "Copy items if needed" and be sure to check your app as target.
...
6) Run ```pod install``` command to update Pods.
...
9) Whenever you want to present ESimKit main page, please call 
	...
	Don't forget to import the module at beginning of your controller file:
...
See Demo app to get ESimKit's assets if you want to customize and sample localized sentences (34 language).

You can use one of these preset localized sentences in your application:
