        ...
        ESimKitManager.shared.startSDK(
            ...
            configuration: ESimKitConfiguration(
                ...
                detailPageConfig: ESimKitDetailPageConfig(
                    ...
                    //features5GImage: ESimKitPNGImage(photo: UIImage(named: "xyesim_5g3_black")),
                    //featuresLTEImage: ESimKitPNGImage(photo: UIImage(named: "xyesim_lte_black")),
                    //featuresHotspotImage: ESimKitPNGImage(photo: UIImage(named: "xyesim_hotspot_black")),
                    //featuresInstantActivationImage: ESimKitPNGImage(photo: UIImage(named: "xyesim_5g3_black")),
                    ...
                    //pricesCellImage2: ESimKitPNGImage(photo: UIImage(named: "esim_package_2")),
                    //pricesCellImage3: ESimKitPNGImage(photo: UIImage(named: "esim_package_3")),
                    //pricesCellImage4: ESimKitPNGImage(photo: UIImage(named: "esim_package_4")),
                    //pricesCellImage5: ESimKitPNGImage(photo: UIImage(named: "esim_package_5")),
